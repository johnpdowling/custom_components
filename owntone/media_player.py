"""
Support for interfacing to owntone API.
...
DEFAULT_NAME = 'owntone'
DEFAULT_PORT = 3689
DEFAULT_SSL = False
DEFAULT_TIMEOUT = 10
DOMAIN = 'owntone'

#SUPPORT_OWNTONE = SUPPORT_PAUSE | SUPPORT_VOLUME_SET | SUPPORT_VOLUME_MUTE | \
#    SUPPORT_PREVIOUS_TRACK | SUPPORT_NEXT_TRACK | SUPPORT_SEEK | \
#    SUPPORT_PLAY_MEDIA | SUPPORT_PLAY | SUPPORT_TURN_OFF
SUPPORT_OWNTONE = SUPPORT_VOLUME_SET | SUPPORT_VOLUME_MUTE | \
...
class OwnTone:
    """The owntone API client."""

    def __init__(self, host, port, use_ssl):
        """Initialize the owntone device."""
        self.host = host
        self.port = port
...
class OwnToneDevice(MediaPlayerDevice):
    """Representation of a owntone API instance."""
    ...
    def __init__(self, name, host, port, use_ssl, add_entities):
        ...
        self.client = OwnTone(self._host, self._port, self._use_ssl)
...
class AirPlayDevice(MediaPlayerDevice):
    """Representation an AirPlay device via a owntone API instance."""
